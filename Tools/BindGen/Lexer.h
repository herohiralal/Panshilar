...
ENUM_START(TokenType, u64)
    ...
    #define TokenType_SymbolUnknown                 ((TokenType) (1ULL << 31))
    #define TokenType_Spaces                        ((TokenType) (1ULL << 32))
    #define TokenType_NewLine                       ((TokenType) (1ULL << 33))
    #define TokenType_Tab                           ((TokenType) (1ULL << 34))
    #define TokenType_LineEndComment                ((TokenType) (1ULL << 35))
    #define TokenType_BlockComment                  ((TokenType) (1ULL << 36))
    #define TokenType_IncompleteBlockComment        ((TokenType) (1ULL << 37))
    #define TokenType_Unused38_____________________ ((TokenType) (1ULL << 38))
    #define TokenType_Unused39_____________________ ((TokenType) (1ULL << 39))
