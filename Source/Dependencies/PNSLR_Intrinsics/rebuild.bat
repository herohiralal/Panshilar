...
%TOOLCHAINS%\Android\toolchains\llvm\prebuilt\windows-x86_64\bin\clang.exe --target=aarch64-linux-android28 -c -std=c11 .\Intrinsics.c -o Prebuilt\intrinsics-android-arm64.o -I%TOOLCHAINS%\Android\toolchains\llvm\prebuilt\windows-x86_64\sysroot\usr\include\ %CLANG_WARNINGS%
if %errorlevel% neq 0 (
